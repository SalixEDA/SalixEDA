...
class SdScriptValueFunFaceEquidistantXY : public SdScriptValueFunction
  ...
  public:
    //                                                                                                     src                   distance             matrix
    SdScriptValueFunFaceEquidistantXY( Sd3drModel *model ) : SdScriptValueFunction( SD_SCRIPT_TYPE_FACE, SD_SCRIPT_TYPE_FACE, SD_SCRIPT_TYPE_FLOAT, SD_SCRIPT_TYPE_MATRIX ), mModel(model) { }
