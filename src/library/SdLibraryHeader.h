...
Description
  All variable cad objects saved in library.
  ...
  All information saved in three files: references file, headers file and objects files. References file contains
  map of all known objects with reference to its header and object.

  This is Header class. Header is a short object description.
*/
