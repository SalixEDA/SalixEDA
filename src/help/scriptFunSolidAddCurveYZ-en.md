...
## Description
Extends the body from the last face by performing a turn in the YZ plane (around the X axis).
...
body = solidAddCurveYZ( body, 3, 12, 150 )
...
![pic](scriptFunSolidAddCurveYZ.png)
