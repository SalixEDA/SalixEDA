...
## Description
Adds an array of blind holes to the last face of the shape. The array consists of groups of holes with an arbitrary color, arranged in a row. Each group is described by four numbers in the `groups` parameter.
...
- bodyColor - color of the inner part of the holes
