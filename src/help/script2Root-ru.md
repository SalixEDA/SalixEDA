...
| Наименование функции | Описание |
|--------------------------------|--------------|
| [solidNew](scriptFunSolidNew.md) |Формирует тело из произвольного контура|
| [solidTube](scriptFunSolidTube.md) |Формирует трубу|
| [solidTubeColor](scriptFunSolidTubeColor.md)|Формирует трубу с заданием цвета внутренней части|
| [solidTubeDif](scriptFunSolidTubeDif.md) |Формирует трубу с различными формами внешней и внутренней частей|
| [solidTubeDifColor](scriptFunSolidTubeDifColor.md) |Формирует трубу с различными формами внешней и внутренней частей и с заданием цвета внутренней части|
...
| Наименование функции | Описание |
|--------------------------------|--------------|
| [solidAddCone](scriptFunSolidAddCone.md) |Добавляет конус|
