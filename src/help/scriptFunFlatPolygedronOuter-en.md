...
## Description
Creates a 2D contour (projection) of a regular polygon specified by a circumscribed circle.

## Parameters
- radius - radius of the circumscribed circle (distance from the center to a vertex)
