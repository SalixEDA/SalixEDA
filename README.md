...
Клонируйте проект с помощью git или zip в отдельный каталог. Из QtCreator откройте файл проекта SalixEDA.pro. Выберите в QtCreator команду "Собрать". Проект SalixEDA полностью самодостаточен и не требует каких либо внешних зависимостей.
